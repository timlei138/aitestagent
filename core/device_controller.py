...
class DeviceController:
    def __init__(self, serial: str | None = None):
        ...
        try:
            ...
            raise DeviceUnavailableError(f"无法连接 Android 设备: {exc}") from exc
        ...
        self._current_app_cache_ttl_sec: float = 1.5
    ...
    def current_app(self) -> dict[str, Any]:
        ...
        if now - last_ts <= max(0.0, cache_ttl):
            return dict(getattr(self, "_last_current_app", {"package": "", "activity": ""}))
